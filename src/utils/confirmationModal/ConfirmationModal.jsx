function ConfirmationModal({title="Are you sure you want to do that?!", acceptEvent = ()=>{}, denyEvent=()=>{}, setPopup}) {
    return (
        <div className="absolute w-[100vw] h-[100vh] top-0 left-0 backdrop-filter backdrop-brightness-50 grid place-items-center ">
            <div className="rounded-md p-6 bg-white text-black text-2xl">
